...
const STORAGE_KEY = 'raden_projects'
...
const defaultProjects = [
    ...
    status: 'COMPLETED',
    year: '2026',
    shortDesc: 'Full-stack e-commerce website built with Node.js, Express, Prisma, React, TypeScript, and Gemini AI integration.',
    problem: 'Needed a modern e-commerce platform with AI-powered features, clean UI, and a full backend API — built from scratch as a personal project.',
    solution: 'Developed a full-stack e-commerce app with product catalog, cart, authentication (JWT), and Gemini AI integration. Frontend in React + Vite + TypeScript, backend in Node.js + Express + Prisma, database on Aiven MySQL, deployed on Railway.',
    result: 'Successfully deployed and live. Full e-commerce flow functional — browse products, cart, register, login, and AI features running in production.',
    tech: ['Node.js', 'Express', 'Prisma', 'React', 'TypeScript', 'Vite', 'MySQL', 'JWT'],
    photos: ['https://res.cloudinary.com/doynrjor3/image/upload/v1782289088/Screenshot_3032_sloy4o.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1782289089/Screenshot_3033_wpgvtf.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1782289087/Screenshot_3034_xwz93i.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1782289088/Screenshot_3035_pkzmyf.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1782289088/Screenshot_3037_daquni.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1782289089/Screenshot_3038_olqal8.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1782289088/Screenshot_3039_clzzwh.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1782289089/Screenshot_3040_ky1qnz.png'],
    github: 'https://github.com/radenaja/Luxora',
    demo: 'https://luxora-production-4e39.up.railway.app',
  },
  {
    id: 7,
    ...
    photos: ['https://res.cloudinary.com/doynrjor3/image/upload/v1780285763/Screenshot_2736_sipc03.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1780285767/Screenshot_2729_zskiym.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1780285767/Screenshot_2730_btasvb.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1780285766/Screenshot_2731_gi9op3.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1780285766/Screenshot_2732_mvqth1.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1780285766/Screenshot_2733_slqms4.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1780285766/Screenshot_2734_f7cuk3.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1780285765/Screenshot_2735_zkmytb.png'],
  ...
  {
    id: 9,
    name: 'Payroll Data Validation Analysis',
    type: 'PERSONAL',
    status: 'COMPLETED',
    year: '2025',
    shortDesc: 'Data analytics project — validating payroll data accuracy across 1,000+ employee records using Python and Excel.',
    problem: 'Payroll data across a large employee dataset was prone to misalignment, especially for employees with promotions or position changes.',
    solution: 'Analyzed 1,000+ employee payroll records using Python and Excel to validate salary alignment and detect discrepancies related to promotions and position changes.',
    result: 'Identified 20+ payroll discrepancies, providing actionable insights to improve payroll data accuracy and consistency.',
    tech: ['Python', 'Excel', 'Pandas', 'Data Analytics'],
    photos: ['https://res.cloudinary.com/doynrjor3/image/upload/v1782291627/Screenshot_3045_anwrl1.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1782291626/Screenshot_3042_k21hib.png'],
    github: '',
    demo: '',
  },
  {
    id: 10,
    name: 'Patient MCU Data Quality Analysis',
    type: 'PERSONAL',
    status: 'COMPLETED',
    year: '2025',
    shortDesc: 'Data analytics project — identifying data quality issues in 2,000+ patient Medical Check-Up records.',
    problem: 'Patient MCU records contained data inconsistencies that disrupted continuity of medical history and linkage between records.',
    solution: 'Analyzed 2,000+ MCU patient records to identify history linkage issues and data inconsistencies affecting the integrity of medical records.',
    result: 'Detected 10+ data inconsistencies affecting continuity of patient medical records, supporting data quality improvement efforts.',
    tech: ['Python', 'Excel', 'Pandas', 'Data Analytics'],
    photos: ['https://res.cloudinary.com/doynrjor3/image/upload/v1782291626/Screenshot_3044_gjmjyv.png', 'https://res.cloudinary.com/doynrjor3/image/upload/v1782291626/Screenshot_3043_ciiudv.png'],
    github: '',
    demo: '',
  },
  {
