...
const defaultProjects = [
  {
    ...
    result: 'High SUS Score, black-box testing 100% pass. Accepted as undergraduate thesis. Already live and publicly accessible at my-simara.my.id.',
  ...
  },
  {
    ...
    status: 'COMPLETED',
    year: '2026',
    shortDesc: 'Cooperative management system backend — team collaboration via GitLab.',
    problem: 'The cooperative needed an integrated digital system to manage members, savings, and loans.',
    solution: 'Contributed to the Laravel backend, resolved migration ordering conflicts, and set up SSH keys for GitLab team collaboration.',
    result: 'Core backend modules running smoothly, team Git workflow running seamlessly.',
